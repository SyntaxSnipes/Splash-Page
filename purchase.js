...
let memoryDesc = ""
let memoryCost = 0
let memorySelected = false
let storageDesc = ""
let storageCost = 0
let storageSelected = false
let psupplyDesc = ""
let psupplyCost = 0
let psupplySelected = false
...
let ramOp1 = document.getElementById("ramOp1")
let ramOp2 = document.getElementById("ramOp2")
let ramOp3 = document.getElementById("ramOp2")
...
let psuOp1 = document.getElementById("psuOp1")
let psuOp2 = document.getElementById("psuOp2")
let psuOp3 = document.getElementById("psuOp3")
...
function resetProcessorBorders() {
    ...
    for (let i = 0; i < processorOptions.length; i++) {
        processorOptions[i].style.border = "2px solid #D9DDDC"; // Reset border styles
    }
}
...
function updateProcessorBorder(elementId) {
    ...
    if (element) {
        element.style.border = "2px solid #3882f6"; // Set border style
    }
}
...
function resetMemoryBorders() {
    ...
    for (let i = 0; i < memoryOptions.length; i++) {
        memoryOptions[i].style.border = "2px solid #D9DDDC";
    }
}
...
function updateMemoryBorder(elementId) {
    let element = document.getElementById(elementId);
    if (element) {
        element.style.border = "2px solid #3882f6";
    }
}
...
function resetStorageBorders() {
    ...
    for (let i = 0; i < storageOptions.length; i++) {
        storageOptions[i].style.border = "2px solid #D9DDDC";
    }
}
...
function resetPowerBorders() {
    ...
    for (let i = 0; i < powerOptions.length; i++) {
        powerOptions[i].style.border = "2px solid #D9DDDC";
    }
}
...
function isAllSelected(event) {
    if (!processorSelected || !memorySelected || !storageSelected || !psupplySelected) {
        statusCheck.innerText = "Please select all of your configuration options before proceeding";
